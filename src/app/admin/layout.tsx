...
const navSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/content/news-alerts", label: "News & Alerts", icon: "M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" },
      ...
      { href: "/admin/content/staff", label: "Staff Manager", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" },
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto py-3 px-2 space-y-4">
          {navSections.map((group, gi) => (
            <div key={gi}>
              {sidebarOpen && (
                <p className="px-3 mb-1.5 text-[10px] font-bold uppercase tracking-[0.15em] text-white/40">
                  {group.heading}
                </p>
              )}
