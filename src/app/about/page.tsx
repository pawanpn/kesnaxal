...
export const metadata: Metadata = {
  title: "About Us",
  description: `Learn about ${siteData.school.name} — our history, mission, and leadership.`,
};
...
const values = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path d="M16.5 18.75h-9m9 0a3 3 0 013 3h-15a3 3 0 013-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0a7.454 7.454 0 01-.982-3.172M9.497 14.25a7.454 7.454 0 00.981-3.172M5.25 4.236c-.982.143-1.954.317-2.916.52A6.003 6.003 0 007.73 9.728M5.25 4.236V4.5c0 2.108.966 3.99 2.48 5.228M5.25 4.236V2.721C7.456 2.41 9.71 2.25 12 2.25c2.291 0 4.545.16 6.75.47v1.516M18.75 4.236c.982.143 1.954.317 2.916.52A6.003 6.003 0 0016.27 9.728M18.75 4.236V4.5c0 2.108-.966 3.99-2.48 5.228m0 0a6.023 6.023 0 01-2.77.91 6.023 6.023 0 01-2.77-.91" />
      </svg>
    ),
  },
  {
    ...
    <div className="min-h-screen">
      <section className="bg-primary py-12 lg:py-16">
        <div className="container-custom text-center">
          <h1 className="text-3xl lg:text-4xl font-heading font-bold text-white mb-3">About Us</h1>
          <p className="text-gray-200 max-w-xl mx-auto text-sm">{school.motto}</p>
        </div>
      </section>
      ...
      <section className="py-12 lg:py-16">
        <div className="container-custom grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="text-2xl font-heading font-bold text-primary mb-4">{school.name}</h2>
      ...
      <section className="py-12 lg:py-16 bg-surface">
        <div className="container-custom">
          <h2 className="text-2xl font-heading font-bold text-primary text-center mb-10">Our Core Values</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((v) => (
              <div key={v.title} className="bg-white rounded-xl p-6 text-center shadow-sm border border-border hover:shadow-md transition-shadow">
                <div className="text-primary w-14 h-14 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-4">
                  {v.icon}
                </div>
