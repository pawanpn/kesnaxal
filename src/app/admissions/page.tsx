    ...
    <div className="min-h-screen">
      <section className="bg-primary py-12 lg:py-16">
        <div className="container-custom text-center">
          <h1 className="text-3xl lg:text-4xl font-heading font-bold text-white mb-3">Admissions</h1>
          <p className="text-gray-200 max-w-xl mx-auto text-sm">Begin your child&apos;s journey of excellence at KES</p>
        </div>
      </section>
