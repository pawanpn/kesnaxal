      ...
      <section className="py-12 lg:py-16">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
            {[
              {
                label: t.careers.openPositions,
                value: jobsLoading ? "..." : activeJobs.length.toString(),
                icon: "M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z",
                bg: "bg-primary/5",
              },
              {
                label: t.careers.departments,
                value: jobsLoading ? "..." : [...new Set(activeJobs.map((j) => resolveJob(j, "en").category))].length.toString(),
                icon: "M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10",
                bg: "bg-secondary/10",
              },
              {
                label: t.careers.totalVacancies,
                value: jobsLoading ? "..." : activeJobs.reduce((s, j) => s + j.vacancies, 0).toString(),
                icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z",
                bg: "bg-accent/5",
              },
              {
                label: t.careers.location,
                value: t.careers.kathmandu,
