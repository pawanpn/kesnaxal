          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                required
                className="w-full px-3 py-2.5 border border-border rounded-lg focus:ring-2 focus:ring-primary/30 focus:border-primary outline-none text-sm resize-none"
                placeholder="Write your message..."
              />
            </div>
            <button
              type="submit"
              className="w-full sm:w-auto px-6 py-2.5 bg-primary text-white rounded-lg text-sm font-semibold hover:bg-primary-dark transition-colors"
            >
              Send Message
            </button>
          </form>
          ...
          <ul className="space-y-3 text-sm">
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-muted">{siteData.contact.address}</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <svg className="w-5 h-5 shrink-0 mt-0.5 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <div>
                ...
                <p className="text-muted">{siteData.contact.phone} | {siteData.contact.mobile}</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <svg className="w-5 h-5 shrink-0 mt-0.5 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <div>
                ...
                <p className="text-muted">{siteData.contact.email}</p>
              </div>
            </li>
          </ul>
        </div>
